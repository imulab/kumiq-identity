...
public class PatchUserBulkOperationExecutor extends CommonBulkOperationExecutor<UserPatchContext> {
    ...
    @Override
    protected UserPatchContext createOperationContext(BulkOpRequest.Operation operation) {
        UserPatchContext context = new UserPatchContext();
